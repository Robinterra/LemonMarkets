...
namespace LemonMarkets.Models
{
    ...
    public class TradesLatestSearchFilter
    {
        ...
        public TradesLatestSearchFilter ( string isin, string? mic = null, Sorting sorting = Sorting.None )
        {
            this.Isins = new() { isin };
            this.Mic = mic;
        ...
        public TradesLatestSearchFilter ( List<string> isins, string? mic = null, Sorting sorting = Sorting.None )
        {
            this.Isins = isins;
            this.Mic = mic;
            this.Sorting = sorting;
