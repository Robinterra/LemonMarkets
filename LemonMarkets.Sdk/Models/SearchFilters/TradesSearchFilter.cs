...
namespace LemonMarkets.Models
{
    ...
    public class TradesSearchFilter
    {
        ...
        public TradesSearchFilter ( string isin, string? mic = null, DateTime? from = null, DateTime? to = null, Sorting sorting = Sorting.None )
        {
            this.Isins = new() { isin };
            this.Mic = mic;
            this.From = from;
        ...
        public TradesSearchFilter ( List<string> isins, string? mic = null, DateTime? from = null, DateTime? to = null, Sorting sorting = Sorting.None )
        {
            this.Isins = isins;
            this.Mic = mic;
            this.From = from;
